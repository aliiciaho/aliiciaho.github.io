...
names <- unique(matched_dataset1$Entity)
matched_dataset1$Schizophrenia.... <- as.numeric(matched_dataset1$Schizophrenia....)
matched_dataset1$Bipolar.disorder....<- as.numeric(matched_dataset1$Bipolar.disorder....)
matched_dataset1$Eating.disorders.... <- as.numeric(matched_dataset1$Eating.disorders....)
