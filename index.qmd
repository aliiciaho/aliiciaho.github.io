...
The dataset used includes the columns: - Index: A unique number attached to each observation - Entity: Country name - Code: Country Code - Year: Year of data observed - Schizophrenia, Bipolar disorder, Eating disorders, Anxiety Disorders, Drug use Disorders, Depression, Alcohol Use Disorders: Percenatge of people reported to have the specific mental health disorder
